...
import SobreDialog from './components/SobreDialog.jsx';
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-3xl font-bold">Calculadora de DSR sobre Comissões</h1>
        <SobreDialog />
      </div>
      <ControlesCalculo
        mesAno={mesAno}
        ...
        setConsiderarFeriados={setConsiderarFeriados}
        uf={uf}
        setUf={setUf}
        municipio={municipio}
      ...
      {dias.loading ? <p>Calculando dias úteis...</p> : <RelatorioDSRTable resultados={resultados} totais={totais} />}
    </div>
  );
}
