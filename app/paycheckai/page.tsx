...
import HeaderStats from '@/src/components/paycheckai/dsr/HeaderStats';
import Filters from '@/src/components/paycheckai/dsr/Filters';
import GlobalRates from '@/src/components/paycheckai/dsr/GlobalRates';
import PaymentsTable from '@/src/components/paycheckai/dsr/PaymentsTable';
import {
  Payment,
  BasesSelecionadas,
  AliquotasGlobais,
} from '@/src/types/paycheckai';
import { applyGlobalRatesToRows } from '@/src/lib/paycheckai/data';
...
import { PaycheckAIGuard } from '@/src/components/paycheckai/PaycheckAIGuard';

function PaycheckAIPageContent() {
  ...
  useEffect(() => {
    const fetchCalendarData = async () => {
      ...
      try {
        const response = await fetch(`/api/paycheckai/dsr/calendario?${query.toString()}`);
        if (!response.ok) {
...
export default function PaycheckAIPage() {
  return (
    <PaycheckAIGuard>
      <PaycheckAIPageContent />
    </PaycheckAIGuard>
  );
}
